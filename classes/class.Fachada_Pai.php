...
include_once dirname(__FILE__).'/class.FachadaPHP.php';
include_once dirname(__FILE__).'/artefatos/class.FachadaJava.php';
include_once dirname(__FILE__).'/artefatos/class.FachadaPhyton.php';


class Fachada_Pai extends Classe {
	var $includes;
	var $metodos;
	
	function Fachada_Pai($padrao,$projeto){
