		...
		switch(this.getTipo()){
			case "numero":
				if(isNaN(this.getValor())){
					this.setMensagem('O campo '+this.getLabel()+' deve conter um n�mero v�lido!');
					return false;
				}
			break;
			case "moeda":
				if(!isMoeda(this.getValor())){
					this.setMensagem('O campo '+this.getLabel()+' deve conter um valor de moeda v�lido!');
					return false;
				}
			break;
			case "data":
				if(!isData(this.getValor())){
					this.setMensagem('O campo '+this.getLabel()+' deve conter uma data v�lida!');
					return false;
				}
			break;
			case "cpf":
				if(!verificaCPF(this.getValor())){
					this.setMensagem('O campo '+this.getLabel()+' deve conter um CPF v�lido!');
					return false;
				}
			break;
			default:
